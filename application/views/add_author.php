    ...
    <div class="panel panel-default">
        <div class="panel-body">
            <div class="dataTable_wrapper">
                ...
                <form action="<?php echo base_url()?>evis_app/save_author" method="POST">
                    <div class="col-xs-6">
                        <div class="form-group">
                            <label>Name</label>
                            <input type="text" required name="author_name" class="form-control" placeholder="Enter Author Name">
                        </div>
                        <div class="form-group">
